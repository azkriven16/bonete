...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      // Wire up the visibility pause — without this IntersectionObserver
      // visibilityRef.current.visible stays true forever and autoPauseOffscreen never triggers
      let io: IntersectionObserver | undefined;
      if (autoPauseOffscreen) {
        io = new IntersectionObserver(
          ([entry]) => {
            visibilityRef.current.visible = entry.isIntersecting;
            // Pause the clock when hidden so time doesn't jump on resume
